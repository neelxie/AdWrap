...
export default function ViewWorkspacePage() {
  ...
  // pick the id from params and iterate through workspaces to find the workspace with that id
  ...
  const fetchWorkspaces = async () => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/workspaces/${id}`
      );
  ...
  return (
    <div className="p-6">
      <main className="p-8 max-w-6xl mx-auto bg-white">
        <div className="mb-6">
          <h3 className="text-2xl font-semibold mb-4">Workspace Details</h3>
          <div>{data.name}</div>
          <div>{data.email}</div>
        ...
        <Tabs defaultValue="staticmedia" className="w-full">
          ...
          <TabsContent value="staticmedia">
            ...
            <div className="mt-4 flex justify-between items-center">
              ...
              <div className="flex space-x-2">
                <span className="px-3 py-1 text-sm">Showing 1 of 1 Media</span>
          ...
          <TabsContent value="streetpoles">
            ...
            <div className="mt-4 flex justify-between items-center">
              <span className="text-sm text-gray-600">
                Each page shows a maximum of 2 items
              </span>
              <div className="flex space-x-2">
                <span className="px-3 py-1 text-sm">
                  Showing 1 of 1 Street Poles
                </span>
      ...
      <div className="flex justify-center items-center space-x-4 w-screen py-8">
        <Button
          onClick={() => router.push(`/workspaces/${id}/edit`)}
          className=" w-64 cursor-pointer bg-gray-500 hover:bg-gray-900"
        >
          Back
        </Button>
        <Button
